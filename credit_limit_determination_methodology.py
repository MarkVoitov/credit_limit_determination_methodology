...
LimitMA = aInc1 - KolIzhd * 0.09 - aExpBank1 - aExpAnk1 - aExpBKI1
...
if answer == 'Да':
    ...
    if aInc2string != '':                                # если введена пустая строка,
        aInc2 = int(aInc2string)                         # то преобразовываем string в int, т.к. пустую строку в питоне можно ввесте только в типе данных string
        if aInc2 >= 0:
            ...
            aExpBKI2 = int(input())
            LimitSP = aInc2 * 0.5 - KolIzhd * 0.03 - aExpBank2 - aExpAnk2 - aExpBKI2
